...
r = ne
    , i = r['$_CJV']
o = {
    "\u006c\u0061\u006e\u0067": 'zh-cn',                                            //38是滑动的距离  后面是之前请求的challenge
    "\u0075\u0073\u0065\u0072\u0072\u0065\u0073\u0070\u006f\u006e\u0073\u0065": H(38, "5f3e73632a89228647b8a131c47bc031k5"),
    "\u0070\u0061\u0073\u0073\u0074\u0069\u006d\u0065": "407",      //滑动时间，后面轨迹的生成需要，别太离谱
    "\u0069\u006d\u0067\u006c\u006f\u0061\u0064": "150",  //图片加载所用的时间
    "\u0061\u0061": W.prototype["$_BBEI"](W.prototype['$_FDL'](), aee, aeee),
    "\u0065\u0070": $_CCCP()
}
console.log(o)
...
console.log(u)
    ...
    , l = V['encrypt'](gt['stringify'](o), ne.prototype['$_CCEV']())
...
o = {
    "lang": "zh-cn",
    "userresponse": "aaaaaaaafaffffaf77148",
    "passtime": 366,
    "imgload": 57,
    "aa": "Q(!!Osststtytyttt~tyttt2tttyssssssUs(!!($M)1..-*.---,-/*--.-,h-.,.,.,-.,1$*a",
    "ep": {
        "v": "7.9.0",
        "$_BIo": false,
        "me": true,
    ...
    "h9s9": "1816378497",
    "rp": "0bdc663e9703d9ff53d0d9c4726a423c"
}
